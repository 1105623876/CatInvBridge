...
class SketchBase(object):
    """Base class for sketch_inventor (a collection of curves). """
    ...
    @staticmethod
    def from_dict(stat):
        """construct sketch_inventor from json data
    ...
    def from_vector(vec, start_point, is_numerical=True):
        """construct sketch_inventor from vector representation
    ...
    @property
    def bbox(self):
        """compute bounding box (min/max points) of the sketch_inventor"""
    ...
    def global_trans(self):
        """start point + sketch_inventor size (bbox_size)"""
    ...
    def draw(self, ax):
        """draw sketch_inventor on matplotlib ax"""
        raise NotImplementedError
    ...
    def sample_points(self, n=32):
        """uniformly sample points from the sketch_inventor"""
        raise NotImplementedError
