...
PAD_VAL = -1
N_ARGS_SKETCH = 5 # sketch_inventor parameters: x, y, alpha, f, r
N_ARGS_PLANE = 3 # sketch_inventor plane orientation: theta, phi, gamma
N_ARGS_TRANS = 4 # sketch_inventor plane origin + sketch_inventor bbox size: p_x, p_y, p_z, s
...
MAX_N_LOOPS = 6 # maximum number of loops per sketch_inventor
